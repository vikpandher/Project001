...
TestScene028::TestScene028(Project001::Application* applicationPtr)
...
TestScene028::~TestScene028()
{}

void TestScene028::HandleEvent(Project001::Event& event)
{
    Project001::DispatchEvent<Project001::DeinitializeEvent>(event, std::bind(&TestScene028::ProcessDeinitializeEvent, this, std::placeholders::_1));

    TestSceneBase001::HandleEvent(event);

    Project001::DispatchEvent<Project001::InitializeEvent>(event, std::bind(&TestScene028::ProcessInitializeEvent, this, std::placeholders::_1));
...
void TestScene028::ProcessInitializeEvent(Project001::InitializeEvent& initializeEvent)
{
    LOG_INFO("INITIALIZING:   TestScene028:            " << GetId());
...
void TestScene028::ProcessDeinitializeEvent(Project001::DeinitializeEvent& deinitializeEvent)
{
    instructionScene_.Deinitialize();

    LOG_INFO("DEINITIALIZING: TestScene028:            " << GetId());
}

// private ---------------------------------------------------------------------

void TestScene028::Run_UnitTests() const
{
    int result;
