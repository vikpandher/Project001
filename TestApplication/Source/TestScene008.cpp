...
TestScene008::TestScene008(Project001::Application* applicationPtr)
...
void TestScene008::HandleEvent(Project001::Event& event)
{
    ...
    Project001::DispatchEvent<Project001::InitializeEvent>(event, std::bind(&TestScene008::ProcessInitializeEvent, this, std::placeholders::_1));
...
void TestScene008::ProcessInitializeEvent(Project001::InitializeEvent& initializeEvent)
{
    LOG_INFO("INITIALIZING:   TestScene008:            " << GetId());
...
void TestScene008::ProcessDeinitializeEvent(Project001::DeinitializeEvent& deinitializeEvent)
{
...
void TestScene008::Create2DStarMeshes_2()
{
    // Calculating positions ---------------------------------------------------
