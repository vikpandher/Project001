...
void main()
{
    ...
    // Move this matrix calculation outside the shader
...
// ligting maps
// -----------------------------------------------------------------------------
const char* g_vertexShaderSource04 = R"(#version 330 core
...
const char* g_fragmentShaderSource04 = R"(#version 330 core
