...
namespace Project001
{
    ...
    public:
        ...
        // texture scale can be modified after

        // TODO:
        // endStyle 0 results in an end extended by half width
        // generate line
        bool Generate2DLine_v2(
            ...
            bool beveledCorners = true,
            bool triangulate = s_triangulateByDefault);

        // TODO:
        // generate width modulated line
        // bool Generate2DLine_v3(
        //     unsigned int& index,
        //     const std::vector<glm::vec2>& positions,
        //     const std::vector<float>& widthValues,
        //     size_t endStyle = 0,
        //     size_t cornerStyle = 0,
        //     bool beveledCorners = true,
        //     bool triangulate = s_triangulateByDefault);
