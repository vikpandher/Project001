...
void TestScene001::OnEvent(Project001::Event& event)
{
    ...
    Project001::DispatchEvent<Project001::ScrollEvent>(event, std::bind(&TestScene001::ProcessScrollEvent, this, std::placeholders::_1));
...
void TestScene001::ProcessCursorPositionEvent(Project001::CursorPositionEvent& cursorButtonEvent)
{
...
void TestScene001::ProcessScrollEvent(Project001::ScrollEvent& scrollEvent)
{
...
void TestScene001::ProcessUpdateEvent(Project001::UpdateEvent& updateEvent)
{
    ...
    // _LOG_MESSAGE("RenderTime = %f", workTime_ms.count());
...
void TestScene001::UpdateMainCameraEntityPositionAndRoll(double timestep)
{
...
void TestScene001::UpdateLightEntityPosition()
{
    Project001::LightSource* lightSourcePtr;
    _FAIL_CHECK(componentStoresPtr_->GetComponent<Project001::LightSource>(lightSourceEntityId_, lightSourcePtr));
...
void TestScene001::DeleteDeadEntities()
{
...
void TestScene001::RenderRenderableEntities()
{
