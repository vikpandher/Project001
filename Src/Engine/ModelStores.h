...
namespace Project001
{
    ...
    public:
        ...
        bool LoadModel(const std::string& path, glm::uint& index, bool normalizeSize = true, bool recenter = true, bool triangulate = true);
    ...
    protected:
        ...
        ModelVertex GetModelVertexFromFaceVertex(
